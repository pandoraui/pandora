...
<div class="wrap">
    ...
    <div class="main">
        <section id="typo">
            <h1>排版 <small>详细参见 <a href="modules/typo.html">typo.css</a></small></h1>
            <p>首先应用 Reset 重设，对常用标签进行使用规划，使其应用达到恰到好处的效果。</p>
    
            <h2><a  href="assets/less/normalize.css" title="标签无差异化">normalize</a> 与 <a  href="assets/less/reset.css" title="传统样式重设">reset</a> 重设</h2>
